...
describe('AllPerks page (Directory)', () => {
  ...
  test('lists public perks and responds to merchant filtering', async () => {
    ...
    // Wait for the fetch to finish by waiting for the seeded perk to appear
    await waitFor(() => {
      expect(screen.getByText(seededPerk.title)).toBeInTheDocument();
    });
    ...
    // Wait for filtering to complete and verify the record is displayed
    await waitFor(() => {
      expect(screen.getByText(seededPerk.title)).toBeInTheDocument();
    });
    ...
    // The merchant name should be visible in the filtered results
